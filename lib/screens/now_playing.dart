...
import 'package:musica_app/screens/playlist_screen.dart';
import 'package:on_audio_query/on_audio_query.dart';
import 'package:rxdart/rxdart.dart';
import 'playlist_folder_page/add_button.dart';
              ...
              children: [
                IconButton(
                    ...
                    icon:  Icon(
                      ...
                      size: 40,
                      color:FunctionsData.themvalue==2 ? const Color.fromARGB(255, 86, 10, 35) : const Color.fromARGB(255, 38, 225, 218),
                    )),
              ],
            ),
            SizedBox(
              ...
              child: Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      border: Border.all(
                          width: 2,
                          color:FunctionsData.themvalue !=2 ?  const Color.fromARGB(255, 7, 253, 241): const Color.fromARGB(255, 0, 201, 251)),
                      boxShadow:  [
                        BoxShadow(
                            blurRadius: 16,
                            color:FunctionsData.themvalue !=2 ? const Color.fromARGB(255, 108, 235, 244) : const Color.fromARGB(255, 12, 93, 117),
                            ...
                            builder: (context) {
                              return Container(
                                ...
                                child: ValueListenableBuilder(
                                    valueListenable:
                                        PlaylistFunctions.playlistsong,
                                    builder: (BuildContext context,
                                        List<dynamic> playlistfolder,
                                        Widget? child) {
                                      return Padding(
